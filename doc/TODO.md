...
* The object tree is build before external methods are called. This means that these methods generating sxml objects can search in the tree to insert objects to its proper place.
...
ntree -> [*]
note left of ntree : From this tree it is easy\nto generate XML text
```
